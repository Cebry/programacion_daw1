...
public class Ejercicio16{
  public static void main(String args[]){
    ...
    if ("verdadero".equals(System.console().readLine())){
      aciertos += 3;
    }
    ...
    if (10 >= aciertos){
      ...
      apunte = "¡Enhorabuena! tu pareja parece ser totalmente fiel.";
    }
    else{
      if (22 >= aciertos){
        System.out.printf("\033[36m");
        apunte = "Quizás exista el peligro de otra persona en su vida o en su mente, aunque seguramente será algo sin importancia.No bajes la guardia.";
      }
      else{
          System.out.printf("\033[33m");
          apunte = "Tu pareja tiene todos los ingredientes para estar viviendo un romance con otra persona. Te aconsejamos que indagues un poco más y averigües que es lo que está pasando por su cabeza.";
        }
      }
